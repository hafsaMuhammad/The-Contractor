# Generated by Django 4.2.24 on 2025-09-16 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('category', models.CharField(choices=[('material', 'Material'), ('equipment', 'Equipment'), ('service', 'Service')], default='material', max_length=20)),
                ...
                ('available_quantity', models.DecimalField(blank=True, decimal_places=3, max_digits=12, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
